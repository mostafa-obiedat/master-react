...
import mdrggaImage from '../assets/mdrgga.png';
const woman = () => {
  // بيانات المنتجات
  const products = [
    { id: 1, name: "مدرقة اردنية", price: "63 دينار", image: mdrggaImage },
    { id: 2, name: "مدرقة اردنية", price: "63 دينار", image: mdrggaImage },
    { id: 3, name: "مدرقة اردنية", price: "60 دينار", image: mdrggaImage },
    { id: 4, name: "الجوخة التقليدية الاردنية مصنوعة من ..", price: "60 دينار", image: mdrggaImage },
    { id: 5, name: "الجوخة التقليدية الاردنية مصنوعة من ..", price: "60 دينار", image: mdrggaImage },
    { id: 6, name: "الدامر التقليدي", price: "60 دينار", image: damerImage },
    { id: 7, name: "الجوخة التقليدية الاردنية مصنوعة من ..", price: "60 دينار", image: mdrggaImage },
    { id: 8, name: "الجوخة التقليدية الاردنية مصنوعة من ..", price: "60 دينار", image: mdrggaImage },
